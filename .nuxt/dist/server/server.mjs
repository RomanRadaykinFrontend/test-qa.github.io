import { effectScope, reactive, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, computed, defineComponent, h, isReadonly, isRef, isShallow, isReactive, toRaw, openBlock, createElementBlock, createElementVNode, warn, watch, ref, shallowRef, provide, mergeProps, renderSlot, onUnmounted, toRefs, normalizeClass, onUpdated, createVNode, Fragment, nextTick, useSlots, withCtx, createBlock, resolveDynamicComponent, normalizeStyle, createTextVNode, toDisplayString, createCommentVNode, TransitionGroup, useAttrs as useAttrs$1, withModifiers, Text, Transition, withDirectives, vShow, isVNode, render, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import "klona";
import "devalue";
import { isClient, useEventListener, useResizeObserver, refDebounced, useTimeoutFn } from "@vueuse/core";
import { isString, isObject, hasOwn, NOOP, isFunction, isArray } from "@vue/shared";
import { get, set, fromPairs, castArray, clone, isNil } from "lodash-unified";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D5R6Nngb.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DXZofo_J.js").then((r) => r.default || r));
